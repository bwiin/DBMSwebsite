...
<body>
	<div id="wrapper">
				...
				if ($_SESSION['view'] == 1) { ?>
					...
					<div style="float: left; clear: none; width: calc(100% - 5px); height: 75px;">
						...
						<div style="float: right; line-height: 75px;">
							<a href="studentHomepage.php" onclick="location.href=this.href+'?view=2'; return false;">View My Events</a>
						</div>
					</div>
		...
		<div id="footer">
			<a href="studentHomepage.php">Home</a> | COP4710 &#9733 Group 17 &#9733 Term Project
		</div><!-- #footer -->
