...
<body>
	...
	<div id="wrapper">
					...
					<ul>
						<li>
							<div class="vertical-menu">
								<a href="superAdministratorHomepage.php">Home</a>
								<a href="createEvent.php">Create Event</a>
								<a href="createUniversityProfile.php">Create University Profile</a>
			...
			if ( (isset($_SESSION['loggedIn'])) && ($_SESSION['loggedIn'] == TRUE) ) {
				...
				if ($_SESSION['view'] == 1) { ?>
					...
					<div style="float: left; clear: none; width: calc(100% - 5px); height: 75px;">
						...
						<div style="float: right; line-height: 75px;">
							<a href="superAdministratorHomepage.php" >View My Events</a>
						</div>
					</div>
				...
				//Show just the events that the user (admin or student) has registered for.
					...
					<div style="float: left; clear: none; width: calc(100% - 50px); height: 75px;">
						...
						<div style="float: right; line-height: 75px;">
							<a href="superAdministratorHomepage.php" onclick="location.href=this.href+'?view=1'; return false;">View All Events</a>
						</div>
					</div>
		...
		<div id="footer">
			<a href="superAdministratorHomepage.php">Home</a> | COP4710 &#9733 Group 17 &#9733 Term Project
		</div><!-- #footer -->
